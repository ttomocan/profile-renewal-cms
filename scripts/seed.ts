...
export const mockResults: ResultItem[] = [
  {
    ...
    period: 202401,
    'result-role': [
      { id: 'role-design', name: 'UI/UXデザイン' },
      { id: 'role-frontend', name: 'フロントエンド開発' },
      { id: 'role-backend', name: 'WordPress構築' }
    ],
  ...
  },
  {
    ...
    workType: {
      id: 'work-type-freelance',
      name: 'フリーランス'
    },
    'result-project-type': {
      id: 'project-type-blog',
      name: 'ブログ'
    },
    // cover未設定でテスト
    // clientName未設定でテスト
  ...
  },
  {
    ...
    period: 202403,
    'result-role': [
      { id: 'role-ux', name: 'UXデザイン' },
      { id: 'role-ui', name: 'UIデザイン' },
      { id: 'role-frontend', name: 'フロントエンド開発' }
    ],
...
export const mockWorkTypes = [
  { id: 'work-type-main', name: 'メイン業務' },
  { id: 'work-type-freelance', name: 'フリーランス' },
  { id: 'work-type-side', name: '副業' }
];

export const mockProjectTypes = [
  { id: 'project-type-corporate', name: 'コーポレートサイト' },
  { id: 'project-type-blog', name: 'ブログ' },
  { id: 'project-type-ec', name: 'ECサイト' },
  { id: 'project-type-lp', name: 'ランディングページ' },
  { id: 'project-type-app', name: 'Webアプリ' }
];

export const mockRoles = [
  { id: 'role-design', name: 'UI/UXデザイン' },
  { id: 'role-frontend', name: 'フロントエンド開発' },
  { id: 'role-backend', name: 'バックエンド開発' },
  { id: 'role-wordpress', name: 'WordPress構築' },
  { id: 'role-seo', name: 'SEO対策' },
  { id: 'role-consulting', name: 'コンサルティング' }
];
