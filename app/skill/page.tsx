    ...
    <>
      <section className="first inner">
        <p className="fadeUpTrigger">
          ...
          <br />
          さらに、スキマ時間や休日には、ブログ運営で培ったノウハウを活かし、Webライティングやコンテンツマーケティングにも挑戦しています。「こんなことがやりたい！」というご要望をしっかりと受け止め、オリジナリティあふれるアイデアや戦略でWebサイトを形にすることを心掛けています。
        </p>
      </section>
      ...
      <section className="ai-tool inner inner-s">
        ...
        <div className="ai-tool__item fadeUpTrigger">
          <div className="ai-tool__image">
            <svg fill="currentColor" fill-rule="evenodd" height="100" viewBox="0 0 24 24" width="100" xmlns="http://www.w3.org/2000/svg">
