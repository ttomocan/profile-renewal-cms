      ...
      <section className="framework inner inner-s">
        ...
        <div className="programming__item fadeUpTrigger">
          ...
          <div className="programming__detail">
            ...
            <p>Next.jsを使用したモダンなWebアプリケーション開発を得意としています。App RouterやServer Componentsなどの最新機能を活用し、SEOに強く高速なWebサイトを構築します。静的生成（SSG）とサーバーサイドレンダリング（SSR）を適切に使い分け、最適なパフォーマンスを実現します。</p>
          </div>
        </div>
        <div className="programming__item fadeUpTrigger">
          <div className="programming__image">
        ...
        <div className="programming__item fadeUpTrigger">
          ...
          <div className="programming__detail">
            ...
            <p>TypeScriptを使用した型安全なコード開発を実践しています。インターフェース、ジェネリクス、型推論などの機能を活用し、バグの少ない堅牢なコードベースを構築します。特にReactとの組み合わせによる型安全なコンポーネント開発を得意としています。</p>
          </div>
        </div>
      </section>
