          ...
          <div className="p-top-about__cont">
            ...
            <div className="p-top-about__detail fadeUpTrigger">
              <p>
                ...
                <br />
                これまで2社のWeb制作会社で10年以上にわたり、コーポレートサイトやブログ、ECサイトなど多様なWebサイトの設計・開発・運用に携わってきました。また、個人で2つのブログ運営やWebサービスの開発・販売も行っています。
              </p>
              <p>「Webサイトの集客を強化したい」「ブログで成果を出したい」「デザインやUIを改善したい」など、クライアントの課題に対して最適なソリューションを提案・実装いたします。</p>
              <p>現場で培った実践的なノウハウと最新の技術を活かし、目的に合わせた高品質なWebサイト・ブログを丁寧に制作します。ご相談・ご依頼はお気軽にご連絡ください。</p>
            </div>
