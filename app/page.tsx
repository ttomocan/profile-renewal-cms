      ...
      <div className="hero">
        <div className="hero__image">
          <picture>
            ...
            <Image src="/img/pages/top/img_hero.jpg" alt="ノートパソコン" width={1366} height={400} priority sizes="(max-width: 767px) 100vw, 1366px" placeholder="blur" blurDataURL="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAUA..." />
          </picture>
        </div>
        ...
        <section className="skill l-inner">
          ...
          <div className="skill__cont c-row">
            <div className="skill__item col flipDownTrigger">
              <Image src="/img/pages/top/img_programming.jpg" alt="プログラミングのイメージ写真" width={300} height={200} sizes="100vw" />
            ...
            <div className="skill__item col flipDownTrigger">
              <Image src="/img/pages/top/img_web-tool.jpg" alt="サイト制作ツールのイメージ写真" width={300} height={200} sizes="100vw" />
            ...
            <div className="skill__item col flipDownTrigger">
              <Image src="/img/pages/top/img_seo.jpg" alt="SEOのイメージ写真" width={300} height={200} sizes="100vw" />
        ...
        <section className="contact l-inner">
          ...
          <div className="contact__cont c-row flipDownTrigger">
            <div className="contact__img col-img">
              <Image src="/img/pages/top/img_contact.jpg" alt="お問い合わせのイメージ写真" width={310} height={200} sizes="(max-width: 640px) 100vw, 100vw" />
            </div>
