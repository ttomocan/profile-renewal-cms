      ...
      <div className="p-top-hero">
        <div className="p-top-hero__image">
          <picture>
            ...
            <Image src="/img/pages/top/img_hero.jpg" alt="メインビジュアルの背景画像" width={2732} height={1000} sizes="100vw" placeholder="blur" blurDataURL="/img/pages/top/img_hero-placeholder.jpg" priority loading="eager" />
          </picture>
        </div>
